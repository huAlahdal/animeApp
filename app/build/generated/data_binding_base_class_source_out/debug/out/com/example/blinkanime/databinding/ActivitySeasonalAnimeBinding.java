...
public final class ActivitySeasonalAnimeBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySeasonalAnimeBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static ActivitySeasonalAnimeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySeasonalAnimeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_seasonal_anime, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySeasonalAnimeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySeasonalAnimeBinding((CoordinatorLayout) rootView, progressCircular,
          tabLayout2, toolbar, viewPager2);
    }
